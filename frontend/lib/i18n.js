...
const it = {
  ...
  "finder.search_routes": "Cerca un itinerario per nome o zona",
  "finder.search_crags": "Cerca una falesia per nome o regione",
  "finder.clear_search": "Cancella la ricerca",
  "finder.near": "Vicino a me",
  "finder.near_title": "Ordina per distanza dal punto che hai scelto sulla mappa, o dalla tua posizione",
  "finder.locating": "Cerco la tua posizione…",
  "finder.locate_failed": "Posizione non disponibile. Clicca un punto sulla mappa per cercare lì.",
  "finder.near_to": "Vicino a",
  "finder.ref_home": "la tua posizione",
  "finder.ref_pin": "il punto scelto sulla mappa",
  "finder.use_my_position": "usa la mia posizione",
  "finder.pin_hint": "clicca sulla mappa per cercare altrove",
  "finder.no_ref": "Nessun punto di riferimento: clicca sulla mappa o consenti la posizione.",
  "finder.close_near": "Chiudi \"vicino a\"",
  "finder.results": "{n} risultati",
  "finder.no_results_routes": "Nessun itinerario corrisponde alla ricerca.",
  "finder.no_results_crags": "Nessuna falesia corrisponde alla ricerca.",
  "finder.approx_title": "Itinerario senza traccia: distanza dall'area in cui si trova, non dalla partenza",
  "finder.in_area": "in zona",
  "finder.area": "zona",
  "falesie.disclaimer":
...
const en = {
  ...
  "finder.search_routes": "Search a route by name or area",
  "finder.search_crags": "Search a crag by name or region",
  "finder.clear_search": "Clear search",
  "finder.near": "Near me",
  "finder.near_title": "Sort by distance from the point you picked on the map, or from your location",
  "finder.locating": "Finding your location…",
  "finder.locate_failed": "Location unavailable. Click a point on the map to search there.",
  "finder.near_to": "Near",
  "finder.ref_home": "your location",
  "finder.ref_pin": "the point picked on the map",
  "finder.use_my_position": "use my location",
  "finder.pin_hint": "click the map to search elsewhere",
  "finder.no_ref": "No reference point: click the map or allow location access.",
  "finder.close_near": "Close \"near me\"",
  "finder.results": "{n} results",
  "finder.no_results_routes": "No route matches your search.",
  "finder.no_results_crags": "No crag matches your search.",
  "finder.approx_title": "Route without a track: distance from its area, not from the trailhead",
  "finder.in_area": "in the area",
  "finder.area": "area",
  "falesie.disclaimer":
